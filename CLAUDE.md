...
- Étudiant (voyageur) : planifie son séjour, 
...
10. Logement étudiant : résidences CROUS-like, 
    colocations, filtres (budget/distance campus)
...
13. Communauté étudiante : avis et notes laissés 
    par d'autres étudiants (pas les touristes classiques)
...
- Code commenté (évalué en soutenance)
